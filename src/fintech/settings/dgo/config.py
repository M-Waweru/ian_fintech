...
DEFAULT_FILE_STORAGE = "fintech.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "fintech.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "fintech.settings.dgo.utils.MediaRootS3BotoStorage"
